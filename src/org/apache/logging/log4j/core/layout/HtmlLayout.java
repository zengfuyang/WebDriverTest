...
public final class HtmlLayout extends AbstractStringLayout {
    ...
    public String toSerializable(final LogEvent event) {
        ...
        if(event.getLevel().equals(Level.ERROR)){
        	...
        	sbuf.append(new SimpleDateFormat("yyy MMM dd HH:mm:ss.SSS").format(new java.util.Date()));
        	sbuf.append("</font>");
        }else{
        	sbuf.append(new SimpleDateFormat("yyy MMM dd HH:mm:ss.SSS").format(new java.util.Date()));
        }
...
//        sbuf.append("</td>").append(Constants.LINE_SEPARATOR);
        ...
        if (event.getLevel().equals(Level.DEBUG)) {
            ...
            sbuf.append("</font>");
        } else if (event.getLevel().isMoreSpecificThan(Level.ERROR)) {
            sbuf.append("<font color=\"#FF0000\"><strong>");
            sbuf.append(Transform.escapeHtmlTags(String.valueOf(event.getLevel())));
...
//        sbuf.append("</td>").append(Constants.LINE_SEPARATOR);
    ...
    public byte[] getHeader() {
        ...
        sbuf.append(Constants.LINE_SEPARATOR);
        sbuf.append("<tr>").append(Constants.LINE_SEPARATOR);
        sbuf.append("<th>ExecutionTime</th>").append(Constants.LINE_SEPARATOR);
